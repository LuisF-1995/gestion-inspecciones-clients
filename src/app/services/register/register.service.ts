...
export class RegisterService {
  ...
  async register(apiUrl:string, endpoint:string, data:{nombre:string, telefono:String, email:string, password:string}, token?:string): Promise<{success:boolean, message:string}> {
